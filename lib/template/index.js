...
<html>
  ...
  <iframe
    id="player"
    src="https://player.vimeo.com/video/${id}?playsinline=0&autoplay=${autoPlay ? '1' : '0'}&muted=1&potrait=0&loop=${loop ? '1' : '0'}&controls=${controls ? '1' : '0'}&speed=${speed ? '1' : '0'}"
  ...
  <script>
    ...
    const getTime = async () => {
      ...
      sendEvent('currentTime', currentTime);
    };
